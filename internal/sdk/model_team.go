...
// UnmarshalJSON validates required property keys then unmarshals into Team
func (o *Team) UnmarshalJSON(data []byte) (err error) {
	...
	if value, exists := allProperties["users"]; exists {
		if err = json.Unmarshal(value, &decoded.Users); err != nil {
			return err
		}
	}
...
// AssertTeamRequired checks complex required fields (models, arrays, maps) and embedded parents.
