...
// UnmarshalJSON validates required property keys then unmarshals into Agent
...
// AssertAgentRequired checks complex required fields (models, arrays, maps) and embedded parents.
