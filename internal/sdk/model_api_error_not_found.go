...
// UnmarshalJSON validates required property keys then unmarshals into ApiErrorNotFound
...
// AssertApiErrorNotFoundRequired checks complex required fields (models, arrays, maps) and embedded parents.
