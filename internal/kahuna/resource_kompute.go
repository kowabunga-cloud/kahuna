...
func NewKompute(projectId, zoneId, hostId, poolId, templateId, name, desc, profile, profileId string, cpu, mem, disk, data int64, public bool, subnetPeerings []string, uefi bool) (*Kompute, error) {
	...
	instance, err := NewInstance(projectId, hostId, name, desc, profile, profileId, cpu, mem, adapters, volumes, uefi)
	if err != nil {
		_ = osVolume.Delete()
		if dataVolume != nil {
			_ = dataVolume.Delete()
